...
def run_m8(n_train, n_test, finger, patch_type):
    model_name = 'M8'
    model = net.SimpleCNN(patch_type)
    print(model.parameters())

    train, val, x_train, x_val, standardization_dict = tm.prep_data_cnn(n_train, n_test, finger, patch_type, 256, True, 5)
    ...
    print('relative error: ', rel_err_inferior_to.item()*100, '%')
...
if __name__ == '__main__':
    ...
    finger = 'index'
    patch_type = 'tip'
    run_m8(n_train, n_test, finger, patch_type)