...
class SimpleCNN(nn.Module):
    def __init__(self, input_size = (6,6)):
        ...
        _pool_stride = 2
        out_h = math.floor(out_h-(_kernel_size-1)-1)/_pool_stride + 1
        out_w = math.floor(out_w-(_kernel_size-1)-1)/_pool_stride + 1
        ...
        self.conv3 = nn.Conv2d(in_channels=12, out_channels=max_depth, kernel_size=2, stride=1, padding=1)
        out_h = math.floor(out_h+2*_padding-(_kernel_size-1)-1)/_stride + 1
        out_w = math.floor(out_w+2*_padding-(_kernel_size-1)-1)/_stride + 1
