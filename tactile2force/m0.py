...
from models.m0_linear_decoupled_no_bias import M0
...
def run_m0(n_train, n_test, finger, patch_type):
    model = M0()
    model_name = 'M0'
    ...
    print([model.model_params_x, model.model_params_y, model.model_params_z])


    tm.plot_and_save_results(model_name, finger, now_str, y_train, train_fit, 
                            y_val, test_fit, std_force, F_train_fit, F_train, F_val_fit, F_val)
...
if __name__ == '__main__':
    ...
    finger = 'index'
    patch_type = 'tip'
    run_m0(n_train, n_test, finger, patch_type)