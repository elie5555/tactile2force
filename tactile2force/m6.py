...
def run_m6(n_train, n_test, finger, patch_type):
    model_name = 'M6'
    model = net.CNN2(patch_type)
...
if __name__ == '__main__':
    ...
    finger = 'index'
    patch_type = 'tip'
    run_m6(n_train, n_test, finger, patch_type)